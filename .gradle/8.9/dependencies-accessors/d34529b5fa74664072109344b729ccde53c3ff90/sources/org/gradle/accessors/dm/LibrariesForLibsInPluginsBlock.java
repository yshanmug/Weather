...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ErrorLibraryAccessors laccForErrorLibraryAccessors = new ErrorLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>error</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ErrorLibraryAccessors getError() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForErrorLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class ErrorLibraryAccessors extends SubDependencyFactory {
        private final ErrorProneLibraryAccessors laccForErrorProneLibraryAccessors = new ErrorProneLibraryAccessors(owner);

        public ErrorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>error.prone</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ErrorProneLibraryAccessors getProne() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
    ...
    public static class ErrorProneLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>error.prone.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAnnotations() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("error.prone.annotations");
        }
    ...
    public static class LottieLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>version</b> with <b>com.airbnb.android:lottie-compose</b> coordinates and
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>gms.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final ErrorVersionAccessors vaccForErrorVersionAccessors = new ErrorVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>hiltVersion</b> with value <b>2.49</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lottieVersion</b> with value <b>6.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.error</b>
         */
        public ErrorVersionAccessors getError() {
            return vaccForErrorVersionAccessors;
        }
    ...
    public static class CoilVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coil.version</b> with value <b>2.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ErrorVersionAccessors extends VersionFactory  {
        ...
        public ErrorVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.error.prone</b>
         */
        public ErrorProneVersionAccessors getProne() {
            return vaccForErrorProneVersionAccessors;
        }

    }

    public static class ErrorProneVersionAccessors extends VersionFactory  {

        public ErrorProneVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>error.prone.version</b> with value <b>2.23.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("error.prone.version"); }
    ...
    public static class GmsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>gms.version</b> with value <b>21.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("gms.version"); }
